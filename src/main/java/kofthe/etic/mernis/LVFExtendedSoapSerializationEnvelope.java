...
public class LVFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LVFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LVFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LVFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LVFDateTimeConverter dateTimeConverter = new LVFStandardDateTimeConverter();

    public LVFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LVFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LVFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LVFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LVFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LVFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
