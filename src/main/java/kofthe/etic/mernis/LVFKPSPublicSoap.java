...
public class LVFKPSPublicSoap
{
    ...
    public LVFKPSPublicSoap(){}

    public LVFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LVFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LVFExtendedSoapSerializationEnvelope envelope= new LVFExtendedSoapSerializationEnvelope(LVFExtendedSoapSerializationEnvelope.VER11);
